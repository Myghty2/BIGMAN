...
export default function Projects() {
  ...
  const createProject = () => {
    const projectId = `BG-${String(projectList.length + 1).padStart(3, "0")}`;
    ...
    <div className="min-h-full bg-slate-50 p-6 lg:p-8">
      ...
      <div className="mb-8 flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
        ...
        <button
          type="button"
          onClick={openModal}
          className="inline-flex items-center justify-center gap-2 rounded-xl bg-emerald-600 px-5 py-3 font-semibold text-white shadow-sm transition hover:bg-emerald-700 active:scale-[0.98]"
        >
          <Plus size={19} />
          New Project
        </button>
    ...
    <div className="group overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
      ...
      <div className="p-5">
        ...
        <Link
          ...
          className="mt-5 flex items-center justify-center gap-2 rounded-xl border border-slate-200 py-3 text-sm font-semibold text-slate-700 transition hover:border-emerald-200 hover:bg-emerald-50 hover:text-emerald-700"
        >
          View project
          <ArrowRight
            size={16}
